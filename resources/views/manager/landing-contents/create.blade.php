...
<div class="max-w-xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-slate-900 mb-6">Tambah Konten Landing Page</h1>

    <form method="POST" action="{{ route('manager.landing-contents.store') }}" class="card-panel rounded-2xl border border-slate-200 p-6 space-y-5">
        @csrf
        ...
        <div>
            ...
            <textarea id="content" name="content" rows="5"
                      class="w-full px-4 py-3 rounded-lg bg-white border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-sm resize-none"
