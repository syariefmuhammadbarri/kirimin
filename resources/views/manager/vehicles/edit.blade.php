...
<div class="max-w-xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-white mb-6">Edit Kendaraan</h1>

    <form method="POST" action="{{ route('manager.vehicles.update', $vehicle) }}" class="glass-panel rounded-2xl border border-slate-800 p-6 space-y-5">
        @csrf @method('POST')
