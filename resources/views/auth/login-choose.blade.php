...
<div class="flex flex-col items-center justify-center min-h-[70vh] py-8">
    <div class="w-full max-w-lg">
        ...
        <div class="text-center mb-10">
            <h1 class="text-3xl font-bold tracking-tight text-slate-900 mb-3">Selamat Datang di BAZMA Express</h1>
            <p class="text-sm text-slate-500">Pilih tipe akun untuk melanjutkan</p>
        </div>

        @if (session('status'))
            <div class="mb-6 p-3 rounded-lg bg-blue-950/40 border border-blue-900 text-blue-400 text-sm font-medium text-center max-w-md mx-auto">
                {{ session('status') }}
            </div>
        @endif
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <a href="{{ route('login.form', 'staff') }}" 
               class="group relative block p-8 rounded-2xl glass-panel border-2 border-slate-200 hover:border-blue-400 hover:shadow-xl hover:shadow-blue-900/10 transition-all duration-300">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h2 class="text-xl font-bold text-slate-900 mb-2">Login Staff</h2>
            ...
            <!-- Customer Card -->
            <a href="{{ route('login.form', 'customer') }}" 
               class="group relative block p-8 rounded-2xl glass-panel border-2 border-slate-200 hover:border-emerald-400 hover:shadow-xl hover:shadow-emerald-900/10 transition-all duration-300">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h2 class="text-xl font-bold text-slate-900 mb-2">Login Customer</h2>
                    <p class="text-sm text-slate-500 leading-relaxed">
                        Masuk ke akun customer<br>untuk melacak & booking
                    </p>
