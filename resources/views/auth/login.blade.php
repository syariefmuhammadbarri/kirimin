...
<div class="flex flex-col items-center justify-center min-h-[70vh]">
    <div class="w-full max-w-md p-8 rounded-2xl glass-panel shadow-2xl border border-slate-800/80">
        ...
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold tracking-tight text-white mb-2">Selamat Datang Kembali</h1>
            <p class="text-sm text-slate-400">Masuk ke akun BAZMA Express Anda</p>
        </div>
        ...
        <div class="mt-8 text-center text-sm text-slate-400">
            Belum punya akun? 
            <a href="{{ route('register') }}" class="font-medium text-blue-400 hover:text-blue-300 transition">
                Daftar Sekarang
            </a>
        </div>
    </div>
