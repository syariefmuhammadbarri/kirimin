...
<div class="max-w-6xl mx-auto space-y-8">
    <div class="text-center space-y-4">
        <h2 class="text-3xl font-bold text-slate-900">Cabang & Outlet BAZMA Express</h2>
        <p class="text-slate-500 max-w-2xl mx-auto">Kami hadir di lokasi strategis kota-kota besar untuk memudahkan proses serah terima barang kiriman Anda.</p>
    </div>

    <div class="card-panel rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    @foreach($branches as $branch)
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-6 py-4 text-slate-600 font-mono">{{ $branch->phone }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
